...
public class Tier {
    ...
    public void createRow(String rowName, double rowValue, String categoryName, int catType, double budgetedAmount, int accID, int dueDay){
        Row row = new Row(rowName, rowValue, categoryName, catType, budgetedAmount, accID, dueDay);
        expenses.add(row);
        rowCounter++;
    }
